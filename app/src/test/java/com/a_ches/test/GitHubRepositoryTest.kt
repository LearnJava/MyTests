...
class GitHubRepositoryTest {
    ...
    fun searchGithub_Test() {
        ...
        repository.searchGithub(searchQuery, Mockito.mock(GitHubRepositoryCallback::class.java))
    ...
    fun searchGithub_TestCallback() {
        ...
        val gitHubRepositoryCallBack = Mockito.mock(GitHubRepositoryCallback::class.java)
